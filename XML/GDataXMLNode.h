...
/*
 1. 引入libxml2.tbd动态库
 2. 在Build Settings 中搜索 Header Search Paths, 将值更改为
 /usr/include/libxml2
 3. 搜索 Other Linker Flags, 将值更改为
 -lxml2
 4. 非ARC文件在ARC环境下运行的配置:
 在 Build Phases 的 Compile Sources 中找到非ARC文件对应的 .m 文件, 将 Compiler Flags 的值设为 -fno-objc-arc
 */
